...
public class Philosopher implements Runnable {
    ...
    private final Random random = new Random(3456);
    ...
    public void run() {
                ...
                if (!Main.chairsMutex) {
                    if (Main.occupiedChairs.size() != 1) {
                        ...
                        try {
                            ...
                            if (!Main.occupiedChairs.isEmpty()) {
                                Main.occupiedChairs.get(Main.occupiedChairs.size() - 1).join();
                            }
                            break;
        ...
        Main.mealsEaten = Main.mealsEaten + mealsEaten;
